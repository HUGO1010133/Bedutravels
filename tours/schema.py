...
class Query(graphene.ObjectType):
    ...
    # Se define las respuestas para cada campo definido seimpre debe llevar resolve_ y despues nombre de var "all_zona"
...
class CrearZona(graphene.Mutation):
    ...
    # siempre debe ir mutate(self, info, despues los campos)
